...
public class Solution {
	...
	or more steps. Once it goes down, it can't go up. Each path has a highest node, which is 
	...
	with highest node is the input node, update maximum if necessary (2) returns the maximum sum of 
	the path that can be extended to input node's parent.
	*/
    int maxValue;
